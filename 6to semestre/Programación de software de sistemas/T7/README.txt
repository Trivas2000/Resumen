...
Ud. debe crear el archivo fav.c y programar ahí lo solicitado.
Ya hay una plantilla en fav.c.plantilla.
...
archivo fav.zip que contiene fav.c, con su solución,
...
Entregue por U-cursos el archivo fav.zip

A continuación es muy importante que descargue de U-cursos el mismo
archivo que subió.  Luego examine el archivo fav.c revisando
