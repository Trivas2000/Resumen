...
Ud. debe crear el archivo seleccion.c y programar ahí las funciones
solicitadas. Ya hay una plantilla para seleccion.c en seleccion.c.plantilla.

Debe probar su tarea bajo Debian 11 de 64 bits nativo o virtualizado.
Queda excluido WSL 1 para hacer las pruebas.  Estos son los requerimientos
...
+ make run debe felicitarlo por aprobar este modo de ejecución.  Esta
  prueba será rechazada si alguna de las funciones solicitadas es 80%
  más lenta que la solución del profesor.
...
archivo seleccion.zip que contiene seleccion.c, con su solución,
...
Entregue por U-cursos el archivo seleccion.zip

A continuación es muy importante que descargue de U-cursos el mismo
archivo que subió.  Luego examine el archivo seleccion.c revisando
